...
// this code filters the column which are needed from 35 to 9 columns
...
EV_data = EV_data.select( "Model Year", "Make", "Model" ,"Electric Range", "Odometer Reading", "Odometer Code", "New or Used Vehicle",  "Transaction Year", "State of Residence")
...
DFwithBinary.coalesce(1).write.option("header","true").mode("overwrite").csv("hdfs://nyu-dataproc-m/user/ss14758_nyu_edu/odometer_analysis")
